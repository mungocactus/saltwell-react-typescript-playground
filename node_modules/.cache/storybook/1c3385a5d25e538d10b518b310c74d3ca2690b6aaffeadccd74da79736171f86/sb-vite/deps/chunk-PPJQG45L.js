...
var a = (e3, r) => or(e3, "name", { value: r, configurable: true });
var Ee = ((e3) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e3, {
...
function Dt(e3) {
  var r = e3.displayName || e3.name || "Component", t = a(function(i, s) {
    var u = I.useContext(B);
    return I.createElement(e3, j({
      theme: u,
      ref: s
    }, i));
...
var $t = J(function(e3, r, t) {
  ...
  return d.ref = t, d.className = s, I.createElement(I.Fragment, null, I.createElement(Ra, {
    cache: r,
    serialized: u,
...
var Wt = J(function(e3, r) {
  ...
  var t = e3.styles, n = Y([t], void 0, M.useContext(B));
  if (!Er) {
...
var { window: Pr } = mn;
var hn = a((e3) => ({ color: e3 }), "mkColor");
var go = a((e3) => typeof e3 != "string" ? (import_client_logger.logger.warn(
  `Color passed to theme object should be a string. Instead ${e3}(${typeof e3}) was passed.`
), false) : true, "isColorString");
var bo = a((e3) => !/(gradient|var|calc)/.test(e3), "isValidColorForPolished");
var vo = a(
...
var Co = a((e3) => Object.entries(e3).reduce((r, [t, n]) => ({ ...r, [t]: hn(n) }), {}), "convertColors");
var wn = a(
  ({ colors: e3, mono: r }) => {
    let t = Co(e3);
    return {
...
var Mr = a((e3) => Object.keys(e3).length === 0, "isEmpty");
var ne = a((e3) => e3 != null && typeof e3 == "object", "isObject");
var Ie = a((e3, ...r) => Object.prototype.hasOwnProperty.call(e3, ...r), "hasOwnProperty");
var ke = a(() => /* @__PURE__ */ Object.create(null), "makeObjectWithoutPrototype");
var Sn = a((e3, r) => e3 === r || !ne(e3) || !ne(r) ? {} : Object.keys(e3).reduce((t, n) => {
  if (Ie(r, n)) {
    let o = Sn(e3[n], r[n]);
...
//# sourceMappingURL=chunk-PPJQG45L.js.map
