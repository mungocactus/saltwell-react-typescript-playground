...
export default function PageWeatherTanStack() {
  ...
  navigator.geolocation.getCurrentPosition((position) => {
    ...
    //       `https://api.openweathermap.org/data/2.5/weather?units=metric&lat=${lat}&lon=${lon}&appid=b8b85e414d6d20c6db5e6b69eb3858c9`
    //     );
  ...
  console.log("outside the box", lat);
  // console.log("outside the box", lon);
